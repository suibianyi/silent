<template>
  <div :class="{'has-logo':showLogo}">
    ...
    <el-scrollbar wrap-class="scrollbar-wrapper">
      <el-menu
        :default-openeds="['/MIS/contentManage', '/MAS/attendanceConfig', '/MAS/attendanceData', '/MAS/attendancePersonal', '/MAS/attendanceLeave', '/MRS/reserve', '/device', '/aidevice', '/MIS/materialManage']"
