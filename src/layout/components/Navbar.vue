<template>
  <div class="navbar">
    ...
    <el-menu :default-active="activeGroup" mode="horizontal" background-color="#319cff" text-color="#FFFFFF" active-text-color="#FFFFFF" style="display: inline-block" @select="handleNavbarSelect">
      <template>
      ...
      <!-- <el-menu-item index="basic">基础管理</el-menu-item>
      <el-menu-item index="edu">教务管理</el-menu-item>
      <el-menu-item index="attnd">考勤管理</el-menu-item>
      <el-menu-item index="info">信发管理</el-menu-item>
      <el-menu-item index="dev">设备管理</el-menu-item>
...
export default {
  ...
  computed: {
    ...
    newRouters: function() {
      ...
      const b = this.addRouters.filter(item => {
        if (item.meta.group.key !== 'useradmin' && item.meta.group.key !== 'bigdata' && item.meta.group.key !== 'wechart') {
          return true
        }
      })
